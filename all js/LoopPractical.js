...
// const separateOddEven = function (arr) {
...
// let fiveElementArrayIndex = 0;

// for(x in points) {
//     if(x >= 5) break;
//     console.log(x);
//     fiveElementArray[fiveElementArrayIndex++]  =  points[x];
// };
// console.log(fiveElementArray);
...
// console.log(arraySlice(points,0,3));

// let arrayCopy = function(arr){
...
// const rectangleStar = function (w, h, char = "*") {
...
// console.log(rectangleStar(4,7));
// console.log(rectangleStar(3, 6, "A"));


// const rectangleStar = function ( h, char = "*") {
...
// console.log(rectangleStar(7));
// console.log(rectangleStar(6, "A"));

// const rectangleStarReverse = function ( h, char = "*") {
...
// console.log(rectangleStarReverse(7));
// console.log(rectangleStarReverse(6, "A"));
